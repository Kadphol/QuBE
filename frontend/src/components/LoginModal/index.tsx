...
export default function LoginModal(props) {
  ...
  const guestLogin = () => {
    axios.get(`/guestlogin`).then(() => window.location.reload())
  }
  ...
  const handleNameValid = (e) => {
    ...
    if (name.length === 0) {
      ...
      setErrorNameMsg(
        'ชื่อผู้ใช้งานต้องมีเฉพาะตัวอักษรภาษาอังกฤษและตัวเลขเท่านั้น'
      )
    } else {
      setErrorNameMsg('')
    }
        ...
        {loginModal && (
          <>
            ...
            <form onSubmit={loginUser}>
              <div
                className={`form-group ${styles.formGroup} ${styles.formLabel}`}
              >
                ...
                />
                {errorLoginMsg && (
                  <p className="text-danger">{errorLoginMsg}</p>
                )}
              ...
              >
                ...
                />
                {errorPasswordMsg && (
                  <p className="text-danger">{errorPasswordMsg}</p>
                )}
              </div>
              <div className={`form-group ${styles.formGroup}`}>
                <button
                  className={`form-control btn btn-primary ${styles.fblogin} ${styles.formButton}`}
                  type="submit"
                >
                  เข้าสู่ระบบ
                </button>
            ...
            <div>
              ...
              >
                ยังไม่ได้ลงทะเบียนใช่ไหม? คลิกเลย
              </a>
            </div>
          ...
          <>
            ...
            <form onSubmit={registerUser}>
              ...
              >
                ...
                />
                {errorConfirmPassMsg && (
                  <p className="text-danger">{errorConfirmPassMsg}</p>
                )}
              </div>
              <div className={`form-group ${styles.formGroup}`}>
                <button
