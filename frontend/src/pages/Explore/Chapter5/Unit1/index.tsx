        ...
        return (
                <UnitTemplate
                    ...
                    script={[
                        ...
                        `โดยเรานำกระบวนการแก้ไขปัญหานี้ ไปใช้สร้างเป็นวงจรผ่านการใข้เกตต่าง ๆ เพื่อให้คอมพิวเตอร์ประมวลผลและแก้ไขปัญหาแทนเราได้`,
                        `ฉันจะยกตัวอย่างปัญหาพื้นฐาน นั่นคือ การค้นหาตำแหน่งของสิ่งที่เราสนใจ หรือ Searching 
                        โดยฉันจะไปแอบอยู่หลังประตูบานหนึ่ง`,
                        ...
                        `เยี่ยมไปเลย เธอเจอตัวฉันแล้ว ! ถึงอาจจะใช้เวลานานหน่อย แต่ก็ได้ผลลัพธ์ที่ถูกต้อง`,
