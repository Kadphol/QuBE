        ...
        return (
                <IntroTemplate
                    ...
                    script={[``,
                            ...
                            `ใช่แล้วครับ กระผมเฝ้ารออยู่ที่นี่มานาน เพื่อรอใครสักคนที่จะมาใช้บริการสถานที่นี้อีกสักครั้ง`,
                            `จนกระทั่งได้พบกับพวกเธอ กระผมรู้สึกซึ้งใจจนบรรยายเป็นคำพูดไม่ถูกเลยล่ะครับ ฮือ ฮือ`,
