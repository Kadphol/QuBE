...
class Intro extends React.Component <IProps> {
    ...
    data = {
      ...
      script: [ `ท่านคิดว่าท่านคงฝึกหนักมาน่าดูเลย ข้าจะสอนวิธีเข้าไปต่อสู้กับมังกรร้ายตัวนี้เอง`,
                `มังกรร้ายจะทำการทดสอบความสามารถของท่านด้วยคำถามจำนวน 2 ข้อ โดยเป็นรูปแบบตัวเลือกและทดสอบการต่อวงจร`,
                `ด้านบนซ้ายจะแสดงเวลานับถอยหลัง ซึ่งจะส่งผลต่อคะแนนในข้อนั้น ๆ ส่วนด้านบนขวาจะแสดงคะแนนสะสมทั้งหมด`,
