...
class Intro extends React.Component <IProps> {
    ...
    data = {
      icon: kingIcon,
      frameComponent: [F0,F1,F2,F2,F0],
      script: [ `ท่านคิดว่าท่านคงฝึกหนักมาน่าดูเลย ข้าจะสอนวิธีเข้าไปต่อสู้กับมังกรร้ายตัวนี้เอง`,
                `มังกรร้ายจะทำการทดสอบความสามารถของท่านด้วยคำถามจำนวน 4 ข้อ 
                โดยแบ่งเป็นรูปแบบตัวเลือกจำนวน 2 ข้อ และรูปแบบทดสอบการต่อวงจรอีก 2 ข้อ`,
                ...
                `ส่วนด้านขวาแสดงคะแนนสะสมทั้งหมดที่ท่านทำได้ในรอบนี้ ซึ่งท่านสามารถทำคะแนนสูงสุดได้ที่ 4000 คะแนน`,
